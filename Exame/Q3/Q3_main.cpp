...
int main(void)
{
	...
	GLuint programID = LoadShaders("shaders/myShader.vertexshader", "shaders/myShader.fragmentshader");
	...
	GLuint LightID_1 = glGetUniformLocation(programID, "LightPosition_worldspace_1");
	GLuint LightID_2 = glGetUniformLocation(programID, "LightPosition_worldspace_2");
	GLuint LightID_3 = glGetUniformLocation(programID, "LightPosition_worldspace_3");


	int nbFrames    = 0;

	glm::vec3 s_A = glm::vec3(-5, 0, 0);
	glm::vec3 s_B = glm::vec3(0, 0, 5);
	glm::vec3 s_C = glm::vec3(5, 0, 0);
	...
	do{
		...
		glm::vec3 lightPos_1 = s_A;
		glm::vec3 lightPos_2 = s_B;
		glm::vec3 lightPos_3 = s_C;
		

		if ((startTime + periodo) > currentTime) {
			double atual = currentTime - periodo;
			...
			x = (360 * atual)/periodo
			*/
			glm::mat4 aux_1 = glm::mat4(1.0), aux_2 = glm::mat4(1.0), aux_3 = glm::mat4(1.0);
			aux_1[3][2] = 0;
			aux_2[3][2] = 0;
			aux_3[3][2] = 0;

			float angle = (float)((360 * atual)/periodo);

			aux_1 = glm::rotate(aux_1, angle, glm::vec3(0,1,0));
			aux_2 = glm::rotate(aux_2, angle, glm::vec3(0, 1, 0));
			aux_3 = glm::rotate(aux_3, angle, glm::vec3(0, 1, 0));

			aux_1 = glm::translate(aux_1, s_A);
			aux_2 = glm::translate(aux_2, s_B);
			aux_3 = glm::translate(aux_3, s_C);

			glm::vec3 p_1 = glm::vec3(aux_1[3][0], aux_1[3][1], aux_1[3][2]);
			glm::vec3 p_2 = glm::vec3(aux_2[3][0], aux_2[3][1], aux_2[3][2]);
			glm::vec3 p_3 = glm::vec3(aux_3[3][0], aux_3[3][1], aux_3[3][2]);

			///*
			std::cout << "<" << p_1.x << ", " << p_1.y << ", " << p_1.z << ">"<< std::endl;
			std::cout << "<" << p_2.x << ", " << p_2.y << ", " << p_2.z << ">" << std::endl;
		...
		glUniform3f(LightID_3, lightPos_3.x, lightPos_3.y, lightPos_3.z);
