...
int main(void)
{
	...
	//GLuint teste = glGetUniformLocation(programID, "M");
	...
	GLuint LightIntID = glGetUniformLocation(programID, "luz");
	...
	do{
		...
		*/
		...
		if (time < 5) {
			lightInt = (100 * currentTime) / 5;
			//std::cout << lightInt << std::endl;
		} else {
			//std::cout << time << std::endl;
			lightInt = 100;
		}
		
		glUniform1f(LightIntID, lightInt);
