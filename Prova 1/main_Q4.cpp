...
int main(void)
{
	...
	cout << "Informe o ponto A.x: " << endl;
	cin >> A.x;
	cout << "Informe o ponto A.y: " << endl;
	cin >> A.y;
	cout << "Informe o ponto A.z: " << endl;
	cin >> A.z;

	cout << "Informe o ponto B.x: " << endl;
	cin >> B.x;
	cout << "Informe o ponto B.y: " << endl;
	cin >> B.y;
	cout << "Informe o ponto B.z: " << endl;
	cin >> B.z;

	cout << "Informe o ponto C.x: " << endl;
	cin >> C.x;
	cout << "Informe o ponto C.y: " << endl;
	cin >> C.y;
	cout << "Informe o ponto C.z: " << endl;
	cin >> C.z;
	...
	ModelMatrix = glm::translate(glm::mat4(1.0), C);
	
	glfwSetTime(0.0);

	double lastTime = glfwGetTime();
	double startTime = glfwGetTime(), period = 5;
	...
	do {
		...
		if ((startTime + period) >= currentTime) {
			//cout << "mudando" << endl;
			pos = (A + ((B - A) * (float)currentTime) / float(period - startTime));
			ViewMatrix = glm::lookAt(pos, C, glm::vec3(0, 1, 0));
		}
