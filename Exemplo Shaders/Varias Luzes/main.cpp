...
int main(void)
{
	...
	GLuint programID = LoadShaders("shaders/luzes.vs", "shaders/luzes.fs");
	...
	GLuint LightColor_1 = glGetUniformLocation(programID, "LightColor_1");
	GLuint LightColor_2 = glGetUniformLocation(programID, "LightColor_2");
	GLuint LightColor_3 = glGetUniformLocation(programID, "LightColor_3");
	...
	do{
		...
		glm::vec3 lightPos_1 = glm::vec3(4, 4, 4);
		glUniform3f(LightID_1, lightPos_1.x, lightPos_1.y, lightPos_1.z);

		glm::vec3 lightPos_2 = glm::vec3(-4, 4, -4);
		glUniform3f(LightID_2, lightPos_2.x, lightPos_2.y, lightPos_2.z);

		glm::vec3 lightPos_3 = glm::vec3(0, 4, 0);
		glUniform3f(LightID_3, lightPos_3.x, lightPos_3.y, lightPos_3.z);

		glm::vec3 lColor_1 = glm::vec3(1, 0, 0);
		glm::vec3 lColor_2 = glm::vec3(0, 1, 0);
		glm::vec3 lColor_3 = glm::vec3(0, 0, 1);

		glUniform3f(LightColor_1, lColor_1.x, lColor_1.y, lColor_1.z);
		glUniform3f(LightColor_2, lColor_2.x, lColor_2.y, lColor_2.z);
		glUniform3f(LightColor_3, lColor_3.x, lColor_3.y, lColor_3.z);
